    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {
                title: "컨베이어·이송 시스템",
                desc: "프리플로우어 체인/롤러/벨트/터널건조 등 라인 최적화",
              },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {
                name: "파이프 자동 그루빙 장비",
                spec: "OD 1" - 8" 옵션 / 자동 공급 / 외경 교정 모듈 연동",
              },
              {
                name: "터널형 건조 컨베이어 (250°C)",
                spec: "단열 설계 / PID 온도제어 / 수분·VOC 배기",
              },
              {
                name: "비전검사 로봇 셀",
                spec: "협동로봇(TM20) + 2D/3D 비전 + 디버링/마킹",
              },
            ].map((p, i) => (
      ...
      <section id="process" className="py-20 bg-neutral-50 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ol className="mt-10 grid md:grid-cols-5 gap-6">
            {["요구사항 미팅", "개념설계/견적", "제작/조립", "설치/시운전", "A/S·유지보수"].map(
              (step, i) => (
      ...
      <section id="work" className="py-20 bg-white border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {["라인 통합", "비전검사", "파이프 가공", "로봇 스프레이", "건조 컨베이어", "특수 목적"].map(
              (tag, i) => (
                <div key={i} className="group rounded-2xl overflow-hidden border border-neutral-200 bg-white shadow-sm">
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-1 text-sm text-neutral-600">
                      핵심 성과: 택타임 단축, 불량률 감소, 작업자 안전성 향상 등
                    </p>
                  </div>
                </div>
              )
